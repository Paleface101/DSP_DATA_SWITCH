...
HD_PWD='C:/GitProject/DSP_DATA_SWITCH/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DSP_DATA_SWITCH.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DSP_DATA_SWITCH.tcl
