...
HD_PWD='C:/GitProject/DSP_DATA_SWITCH/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DSP_DATA_SWITCH.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DSP_DATA_SWITCH.tcl -notrace
